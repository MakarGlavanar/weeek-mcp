...
import { registerCreateDeal } from "./create-deal.js";
...
export function registerWriteTools(
  ...
  // CRM
  registerCreateDeal(server, client);

  logger.info("registerWriteTools: 6 write tools registered");
}
